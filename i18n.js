...
window.HatchI18n = (() => {
  ...
  const ZH = {
    ...
    "Operators": "Operator",
    "Find Operators": "查找 Operator",
    "Verified Results": "已验证成果",
    "Become an Operator": "成为 Operator",
    "Log in": "登录",
    "Log out": "退出登录",
    "Sign in": "登录",
    "Sign out": "退出登录",
    ...
    "Clients and Operators message each other straight through Hatch — ask a question, share a file, or check on progress, without leaving the platform.": "客户和 Operator 直接在 Hatch 内互相发消息 —— 提问、分享文件、了解进度，全程无需离开平台。",
    "Direct threads": "一对一会话",
    "Message any Operator before or during a Hatch — no gig-site inbox, no waiting on a bid.": "在 Hatch 开始前或进行中，随时给任意 Operator 发消息 —— 没有零工平台式收件箱，也不用等报价。",
    ...
    "Recommended Operators": "推荐 Operator",
    "Mock matches": "模拟匹配",
    ...
    "✓ Matched to a verified Operator who fits the project": "✓ 匹配到与项目契合的已验证 Operator",
    "Speed": "速度",
    ...
    "No more guessing what to write in a job post. Describe your problem in plain words, and AI shapes it into a brief a verified Operator can act on immediately — real help, faster than any gig site.": "不用再纠结招聘帖怎么写。用大白话说明你的问题，AI 会整理成已验证 Operator 可以立即执行的需求说明 —— 比任何零工平台都快的真实帮助。",
    "Stage 1": "第 1 阶段",
    "Stage 2": "第 2 阶段",
    "Stage 3": "第 3 阶段",
    "Incubating": "孵化中",
    ...
    "A verified Operator develops and refines the solution.": "已验证的 Operator 开发并打磨解决方案。",
    ...
    "An Operator might still ask…": "Operator 可能还会问…",
    ...
    "Ready": "就绪",
    "In progress": "进行中",
    "Your project brief has enough detail for Operators to understand the work.": "你的需求说明已足够详细，Operator 可以理解这项工作。",
    ...
    "This is exactly what Operators will see. Check it once, then post it so they can take the work.": "这就是 Operator 将看到的内容。确认一遍后发布，他们即可接单。",
    ...
    "(optional — sent to the Operator)": "（选填 —— 会发送给 Operator）",
    ...
    "Recommended Operator level": "推荐 Operator 等级",
    ...
    "View Operator Profile": "查看 Operator 主页",
    ...
    "Browse verified Operators and message the right one directly.": "浏览已验证的 Operator，直接联系合适的人选。",
    "Operator filters": "Operator 筛选",
    "Name, industry, or tool...": "姓名、行业或工具…",
    "Rating: high to low": "评分：由高到低",
    "Most Hatched": "已孵化最多",
    "On-time: high to low": "准时率：由高到低",
    "No Operators match those filters.": "没有符合筛选条件的 Operator。",
    "✉️ Message": "✉️ 发消息",
    ...
    "Clients post Hatches. Operators hatch them.": "客户发布 Hatch，Operator 负责孵化。",
    "or use email": "或使用邮箱",
    ...
    "Apply to build practical Hatches.": "申请成为 Operator，承接实际工作。",
    "Submit application": "提交申请",
    "Application received.": "申请已收到。",
    "Application progress": "申请进度",
    "Operator application": "Operator 申请",
    "Your Operator application summary will appear here after you apply.": "提交申请后，你的 Operator 申请摘要会显示在这里。",
    "View profile": "查看主页",
    "LinkedIn": "领英",
    ...
    "What helps": "哪些有帮助",
    "Operator Hatches": "Operator 的 Hatch",
    ...
    // ── Admin ────────────────────────────────────────────────────────────────
    "Admin · Operator applications": "管理员 · Operator 申请",
    ...
    "About": "关于",
    "About Hatch.": "关于 Hatch。",
    "Hatch pairs an AI intake assistant with verified Operators so a messy idea becomes a clear, executable brief — then real, delivered work. Clients describe what they need in plain language; Operators deliver it and build a track record that speaks for itself.": "Hatch 把 AI 接入助手和已验证的 Operator 结合起来，把一个模糊的想法变成一份清晰、可执行的需求说明，再变成真正交付的成果。客户用大白话描述需求，Operator 负责交付，并用实际成绩积累起有说服力的履历。",
    ...
    "Review and post": "确认并发布",
    "Check the brief, adjust anything that's off, and post it. Operators see the exact brief you approved — no re-explaining the project.": "确认需求说明，调整不准确的地方，然后发布。Operator 看到的正是你确认过的需求说明 —— 不用再重新解释项目。",
    "An Operator claims it": "Operator 接单",
    "A verified Operator matched to the work claims the Hatch and gets started.": "一位与该工作匹配的已验证 Operator 接下这个 Hatch 并开始处理。",
    "Submit and review": "提交并审核",
    "The Operator submits their work. You review it, request changes if something's missing, or approve it as complete.": "Operator 提交成果后，你来审核 —— 有遗漏可以要求修改，满意就通过并完成。",
    ...
    "One piece of business work — content, a website, a workflow, research — scoped into a brief an Operator can act on without back-and-forth.": "一项具体的商业工作 —— 内容、网站、工作流程、调研 —— 被整理成 Operator 无需反复沟通就能直接执行的需求说明。",
    "Who are Operators?": "Operator 是什么样的人？",
    ...
    "Request changes before approving. If it still isn't resolved, either you or the Operator can open a dispute.": "通过之前可以要求修改。如果仍未解决，你或 Operator 都可以发起争议。",
    "Can I cancel a Hatch?": "可以取消 Hatch 吗？",
    "Yes — the client who posted it can cancel any time before an Operator claims it.": "可以 —— 在 Operator 接单之前，发布该 Hatch 的客户可以随时取消。",
    ...
    "Hatches are grouped by complexity so Operators build up from simpler work.": "Hatch 按复杂度分级，Operator 可从简单工作逐步进阶。",
    "Ranking Signals": "排名信号",
    "Profiles are ranked with delivery signals, not self-claimed expertise alone.": "排名依据交付表现，而非仅凭自述专长。",
    "Operator Trust": "Operator 信任度",
    "Operator cards show Hatched work, ratings, on-time delivery, and category context.": "Operator 卡片展示已孵化工作、评分、准时交付率和领域背景。",
